...
def run(args):
    ...
    # korean ko_KR  sinhala si_LK   nepali ne_NP  french fr_XX   gujarati gu_IN
    # args.src_lang, args.tgt_lang = 'ko_KR', 'ko_KR'
    ...
    model, optimizer, train_dataloader, val_dataloader_ko, val_dataloader_si, val_dataloader_ne, val_dataloader_fr, val_dataloader_gu = accelerator.prepare(model, optimizer, train_dataloader, 
                                                                                                                                        val_dataloader_ko, 
                                                                                                                                        val_dataloader_si,
                                                                                                                                        val_dataloader_ne,
                                                                                                                                        val_dataloader_fr,
...
if __name__ == '__main__':
    ...
    # dataset = load_dataset("csebuetnlp/xlsum", 'gujarati') # korean ko_KR  sinhala si_LK   nepali ne_NP  french fr_XX   gujarati gu_IN
